...
class ImagePath {
  ...
  static const String location = "${base}ic_location.png";
  static const String setting = "${base}ic_setting.png";
  ...
  String addPicture = Constants.darkTheme
      ? "${base}ic_add_picture_light.png"
      : "${base}ic_add_picture_dark.png";
  ...
  static const String helpAndSupport = "${base}ic_help_and_support.png";
  static const String info = "${base}ic_info.png";
  static const String lock = "${base}ic_lock.png";
  static const String mail = "${base}ic_mail.png";
  static const String notifications = "${base}ic_notifications.png";
  static const String phone = "${base}ic_phone.png";
  static const String privacy = "${base}ic_privacy.png";
  static const String question = "${base}ic_question.png";
  ...
  static const String close = "${base}ic_close.png";
  static const String ok = "${base}ic_ok.png";
  static const String image = "${base}ic_image.png";
  static const String pinkCalendar = "${base}ic_pink_calendar.png";
  static const String pinkTime = "${base}ic_pink_time.png";
  static const String pinkLocation = "${base}ic_pink_location.png";
  static const String hurray = "${base}ic_hurray.png";
  static const String add = "${base}ic_add.png";
  static const String withdraw = "${base}ic_withdraw.png";
  static const String greenUp = "${base}ic_green_up.png";
  static const String redDown = "${base}ic_red_down.png";
  static const String masterCard = "${base}ic_master_Card.png";
  static const String debitCard = "${base}ic_debit_card.png";
  static const String paypal = "${base}ic_paypal.png";
  static const String cancelled = "${base}ic_cancelled.png";
  static const String successFull = "${base}ic_successful.png";
  ...
  static const String image_4 = "${base}image_4.png";
  static const String image_5 = "${base}image_5.png";
  static const String image_6 = "${base}image_6.png";
