...
class NewEventDate extends StatefulWidget {
  ...
  const NewEventDate({Key? key, required this.eventName,}) : super(key: key);
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () async {
                                  ...
                                  if (picked != null) {
                                    if (picked.isAfter(DateTime.parse(startDate!))) {
    ...
    if (timeOfDay != null && timeOfDay != time) {
      ...
      startSelectedTime =
          timeOfDay.hour.toString() + " : " +
              (timeOfDay.minute < 10 ? "0" : "") + timeOfDay.minute.toString();
      setState(() {});
    } else {
