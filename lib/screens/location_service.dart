    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Padding(
            padding:
                EdgeInsets.all(ResponsiveFlutter.of(context).moderateScale(20)),
            child: Container(
          ...
          Padding(
            padding: EdgeInsets.only(
                bottom: ResponsiveFlutter.of(context).moderateScale(18),
                right: ResponsiveFlutter.of(context).moderateScale(18),
                left: ResponsiveFlutter.of(context).moderateScale(18)),
            child: Container(
              ...
              child: Center(
                child: TextField(
                  ...
                  style: TextStyle(
                    height: ResponsiveFlutter.of(context).moderateScale(1),
          ...
          Container(
            child: SizedBox(
                height: ResponsiveFlutter.of(context).moderateScale(450),
                width: ResponsiveFlutter.of(context).moderateScale(450),
                child: Image.asset(
                  ImagePath().address,
                  fit: BoxFit.fill,
                )),
