                ...
                onTap: () {
                  Navigator.push(
                    ...
                    PageRouteBuilder(
                      ...
                      pageBuilder: (context, animation, secondaryAnimation) => ClubDetails(image: ImagePath.image_2,nameGroup:groups[index].name,passions: groups[index]
                          .passions, ),
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              CircleAvatar(
                                backgroundImage: NetworkImage(groups[index].profilePicture),
                              ),
                              SizedBox(width: 8),
                              Column(
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  SizedBox(width: 8),
                                  Text('${groups[index].memberCount}', style: TextStyle(color: Colors.white)),
                                ],
                              ),
                            ],
                          ),
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(width: 8),
                              Text('${groups[index].memberCount-6}', style: TextStyle(color: Colors.white)),
                            ],
                          ),
