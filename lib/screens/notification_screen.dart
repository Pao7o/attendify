...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  List<CommonModel>? settingsList = [
    CommonModel(
        image: ImagePath.image_8, title: Strings.dummyText28, subTitle: "1m"),
    CommonModel(
        image: ImagePath.image_7, title: Strings.dummyText29, subTitle: "1m"),
    CommonModel(
        image: ImagePath.image_3, title: Strings.dummyText30, subTitle: "12m"),
    CommonModel(
        image: ImagePath.image_6, title: Strings.dummyText31, subTitle: "1d"),
    CommonModel(
        image: ImagePath.notifications,
        title: Strings.dummyText32,
        subTitle: "5d"),
    CommonModel(
        image: ImagePath.image_6, title: Strings.dummyText33, subTitle: "7d"),
    CommonModel(
        image: ImagePath.success, title: Strings.dummyText34, subTitle: "8d"),
    CommonModel(
        image: ImagePath.success, title: Strings.dummyText35, subTitle: "8d"),
  ];
                          ...
                          Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Image(
                                  image:
                                      AssetImage(settingsList![index].image!),
                                  fit: BoxFit.cover,
                                ),
                              ),
                              index == 3
